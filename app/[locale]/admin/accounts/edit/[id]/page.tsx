        ...
        <div className="space-y-6 max-w-5xl mx-auto pb-10">
            ...
            <div>
                <div className="flex items-center text-sm text-gray-500 mb-4 gap-2">
                    <span className="cursor-pointer hover:text-gray-700 flex items-center gap-1" onClick={() => router.push(`/${locale}${ROUTES.ADMIN_ACCOUNTS}`)}>
                        <ChevronLeft className="h-4 w-4" /> Back to Accounts
                    </span>
                    <span>›</span>
                    <span className="cursor-pointer hover:text-gray-700" onClick={() => router.push(`/${locale}${ROUTES.ADMIN_ACCOUNTS_DETAIL(id)}`)}>User Details</span>
                    <span>›</span>
