...
export default function CreateAccountPage() {
    ...
    const validate = () => {
        ...
        if (username && !/^[a-z0-9._]+$/.test(username)) {
            newErrors.username = "Username contains invalid characters (lowercase, numbers, dots, underscores only)";
        }
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            router.push(`/${locale}${ROUTES.ADMIN_ACCOUNTS}`);
        } catch (error: any) {
        ...
        <div className="space-y-6 max-w-5xl mx-auto pb-10">
            ...
            <div>
                <div className="flex items-center text-sm text-gray-500 mb-4">
                    <span className="cursor-pointer hover:text-gray-700" onClick={() => router.push(`/${locale}${ROUTES.DASHBOARD_ADMIN}`)}>Dashboard</span>
                    <span className="mx-2">›</span>
                    <span className="cursor-pointer hover:text-gray-700" onClick={() => router.push(`/${locale}${ROUTES.ADMIN_ACCOUNTS}`)}>Account Management</span>
                    <span className="mx-2">›</span>
            ...
            <Card className="border border-gray-200 shadow-sm">
                <CardContent className="p-6 space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-2">
                                <User className="inline mr-2 h-4 w-4 text-blue-500" />
                                Username (Optional)
                            </label>
                            <Input
            ...
            <div className="flex items-center gap-4">
                ...
                <Button
                    ...
                    onClick={() => router.push(`/${locale}${ROUTES.ADMIN_ACCOUNTS}`)}
                >
                    Cancel
                </Button>
            </div>
