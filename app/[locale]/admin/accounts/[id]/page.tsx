    ...
    return (
        <div className="space-y-6 max-w-7xl mx-auto pb-10">
            ...
            <nav className="flex items-center text-sm text-gray-500 gap-2">
                <span className="cursor-pointer hover:text-gray-700 flex items-center gap-1" onClick={() => router.push(`/${locale}${ROUTES.DASHBOARD_ADMIN}`)}>
                    <ChevronRight className="h-4 w-4 rotate-180" /> Dashboard
                </span>
                <span>›</span>
                <span className="cursor-pointer hover:text-gray-700" onClick={() => router.push(`/${locale}${ROUTES.ADMIN_ACCOUNTS}`)}>
                    Account Management
                </span>
                <span>›</span>
                ...
                <div className="col-span-12 lg:col-span-4 space-y-6">
                    <Card className="border border-gray-200 shadow-sm">
                        <CardContent className="p-6 space-y-4">
                            ...
                            <Button
                                variant="outline"
                                onClick={() => router.push(`/${locale}${ROUTES.ADMIN_ACCOUNTS_EDIT(id)}`)}
